...
public class SetParameters extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textMaxTemp=findViewById(R.id.maxTemp1);
        textMinTemp=findViewById(R.id.minTemp1);
        textMaxPh=findViewById(R.id.maxPh1);
        textMinPh=findViewById(R.id.minPh1);
        textMaxRh=findViewById(R.id.maxRh1);
        textMinRh=findViewById(R.id.minRh1);
        textLightDuration=findViewById(R.id.lightDuration1);
        textNutrients=findViewById(R.id.tvNutrients);
